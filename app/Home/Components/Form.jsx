...
<div>
    ...
    <input {...register("username",{required:true, minLength:{value:3,message:"Username should be longer!"},maxLength:30})} placeholder='Enter Your Name' type="text" className='border pl-3 border-gray-400 rounded-md w-80 h-10' />
{errors.username && <div className='text-red-500 text-sm'>{errors.username.message} </div>}
</div>
<div>
    <label htmlFor="email">Email:</label> <br />
    <input {...register("email",{ minLength:{value:5,message:"email should be atleast 5 letters"}, pattern:{value: /\S+@+\S+.\S/,message:"Please enter a valid email address"}})}placeholder='Enter Your email' type="email" className='border pl-3 border-gray-400 rounded-md w-80 h-10' />

</div>
<div>
    <label htmlFor="password" >Password:</label> <br />
    <input {...register("password",{required:true, minLength:{value:8,message:"password should be at least 8 letters"},maxLength:30})}placeholder='Enter Your password' type="password" className='border pl-3 border-gray-400 rounded-md w-80 h-10' />
...
<div>
    <label htmlFor="pp">Profile Pic:</label> <br />
...
<div>
    ...
    <input {...register("description",{required:true, minLength:{value:3,message:"Bio should be longer!"}})} placeholder='Enter your Bio' type="text" className='border pl-3 border-gray-400 rounded-md w-80 h-10' />
